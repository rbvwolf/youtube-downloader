    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                ...
                <View style={{ height: 40, marginTop: 16 }}>
                    <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingRight: 16 }}>
                        <TouchableOpacity style={[styles.filterBtn, { backgroundColor: '#0f172a' }]}>
                            <Text style={[styles.filterBtnText, { color: 'white' }]}>All</Text>
                        </TouchableOpacity>
            ...
            <ScrollView style={styles.listContainer} showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <View style={styles.cardInfo}>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 8 }}>
                                ...
                                <MaterialIcons name="pause" size={20} color="#94a3b8" />
                            </View>
                        </View>
                    </View>
                </TouchableOpacity>
                ...
                <TouchableOpacity style={styles.card} activeOpacity={0.9}>
                    <View style={{ flexDirection: 'row' }}>
                        <View style={[styles.thumbnailCont, { backgroundColor: '#fee2e2', alignItems: 'center', justifyContent: 'center' }]}>
                            <MaterialIcons name="headphones" size={32} color="#ea2a33" />
                            <View style={styles.durationBadge}>
                        ...
                        <View style={styles.cardInfo}>
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: 8 }}>
                                <View style={[styles.qualityTag, { backgroundColor: '#fee2e2' }]}>
                                    <Text style={[styles.qualityTagText, { color: '#ea2a33' }]}>Audio</Text>
                                </View>
...
const styles = StyleSheet.create({
    ...
    filterBtn: { height: 36, paddingHorizontal: 20, borderRadius: 18, backgroundColor: '#f1f5f9', alignItems: 'center', justifyContent: 'center', marginRight: 8 },
    filterBtnText: { fontSize: 14, fontWeight: '600', color: '#64748b' },
    listContainer: { flex: 1, paddingHorizontal: 16, paddingTop: 16 },
    card: { backgroundColor: '#ffffff', borderRadius: 24, padding: 12, marginBottom: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 2, borderWidth: 1, borderColor: '#f1f5f9' },
    thumbnailCont: { width: 120, height: 76, borderRadius: 12, backgroundColor: '#e2e8f0', overflow: 'hidden' },
    ...
    progressBarBg: { flex: 1, height: 6, backgroundColor: '#f1f5f9', borderRadius: 3, marginRight: 16, overflow: 'hidden' },
    progressBarFill: { width: '40%', height: '100%', backgroundColor: '#ea2a33', borderRadius: 3 },
    qualityTag: { backgroundColor: '#f1f5f9', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, marginRight: 8 },
    qualityTagText: { fontSize: 10, fontWeight: '600', color: '#64748b' },
});
